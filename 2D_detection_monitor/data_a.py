...
class data_analysis:
    ...
    def data_analysis(self,file_list,output_file):
       ...
       # 直接drop空值
        ...
        df_cleaned['right_landing_point_y'] = data_analysis.remove_small_nan_blocks(df_cleaned, 'right_test_point_y')
        df_cleaned['right_landing_point_x'] = data_analysis.remove_small_nan_blocks(df_cleaned, 'right_test_point_x')
        df_cleaned['right_landing_time'] = data_analysis.remove_small_nan_blocks(df_cleaned, 'right_test_time')
        ...
        df_cleaned['left_landing_point_y'] = data_analysis.remove_small_nan_blocks(df_cleaned, 'left_test_point_y')
        df_cleaned['left_landing_point_x'] = data_analysis.remove_small_nan_blocks(df_cleaned, 'left_test_point_x')
        df_cleaned['left_landing_time'] = data_analysis.remove_small_nan_blocks(df_cleaned, 'left_test_time')
        ...
        avg_stride_time = df_cleaned['right_step_time'].sum() /count 
        ...
        df_smoothed = {
            ...
            "average_stride_length": avg_step_length,
        ...
        with open(json_file_path, 'w') as jsonfile:
            json.dump(df_smoothed, jsonfile, indent=4)

        print("JSON 文件已保存在:", json_file_path)
